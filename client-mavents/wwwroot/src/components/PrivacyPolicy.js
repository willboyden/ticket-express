      ...
      <div className="col-12">
        <div className="row">
          <div className="col-10  justify-content-left">
            <b>
              <h2 className="c7 c4" style={{ fontWeight: "bold" }}>
                Privacy Policy
              </h2>
            </b>

            <p>
              mavents Privacy Policy This Privacy Policy describes how your
              personal information is collected, used, and shared when you visit
              or make a purchase from (the “Site”). PERSONAL INFORMATION WE
              ...
              browse the Site. [[INSERT DESCRIPTIONS OF OTHER TYPES OF TRACKING
              TECHNOLOGIES USED]] Additionally when you make a purchase or
              ...
              numbers [[INSERT ANY OTHER PAYMENT TYPES ACCEPTED]]), email
              address, and phone number. We refer to this information as “Order
              Information.” [[INSERT ANY OTHER INFORMATION YOU COLLECT: OFFLINE
              DATA, PURCHASED MARKETING DATA/LISTS]] When we talk about
              ...
              services. [[INSERT OTHER USES OF ORDER INFORMATION]] We use the
              ...
              INFORMATION We share your Personal Information with third parties
              to help us use your Personal Information, as described above. For
              ...
              our rights. [[INCLUDE IF USING REMARKETING OR TARGETED
              ADVERTISING]] BEHAVIOURAL ADVERTISING As described above, we use
              ...
              You can opt out of targeted advertising by: [[ INCLUDE OPT-OUT
              LINKS FROM WHICHEVER SERVICES BEING USED. COMMON LINKS INCLUDE:
              ...
              a Do Not Track signal from your browser. [[INCLUDE IF LOCATED IN
              OR IF STORE HAS CUSTOMERS IN EUROPE]] YOUR RIGHTS If you are a
              European resident, you have the right to access personal
              ...
              Canada and the United States. DATA RETENTION When you place an
              order through the Site, we will maintain your Order Information
              for our records unless and until you ask us to delete this
              information. [[INSERT IF AGE RESTRICTION IS REQUIRED]] MINORS The
              Site is not intended for individuals under the age of [[INSERT
              AGE]]. CHANGES We may update this privacy policy from time to time
              in order to reflect, for example, changes to our practices or for
              ...
              contact us by e-mail at willboyden+shopifyPP@gmail.com or by mail
              using the details provided below: 30 loring ave, Loring ave,
