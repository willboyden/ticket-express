...
GetSpecificTicketmasterVenueSummary = (venueName) => {
    // Code here
    return (
        `      
                   with ve as   
    ...
    module.exports.GetSpecificTicketmasterVenueSummary 
    ...
    GetSpecificVenueEvents = (venueName) => {
            return(
                `
                    WITH ve as 
                        (
    ...
    module.exports.GetSpecificVenueEvents
    ...
    exports.GetSpecificVenueSummary = function getVenueSummary(params) {
        ...
        else if (params.dataSource == "ticketmaster"){ result = GetSpecificTicketmasterVenueSummary(params.venueName); }
        else
        {
    ...
    GetSpecificVenue = function getVenueSummary(params) {
        var result = "";
    ...
    //works
    GetSpecificStubhubVenueSummary = (venue) => {
    ...
    module.exports.GetSpecificStubhubVenueSummary;
